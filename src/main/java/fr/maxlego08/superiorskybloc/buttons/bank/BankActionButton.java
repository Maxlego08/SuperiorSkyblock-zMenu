package fr.maxlego08.superiorskybloc.buttons.bank;
                ...
                if (percentage.doubleValue() <= 0) {
                    ...
                    PlayerChat.listen(player, message -> {
                        try {
                            ...
                            MenuActions.handleDeposit(clickedPlayer, island, bankTransaction, null, null, newAmount);
                    ...
                    MenuActions.handleDeposit(clickedPlayer, island, bankTransaction, null, null, amount);
                }
                break;
            case WITHDRAW:
                if (percentage.doubleValue() <= 0) {
                    ...
                    PlayerChat.listen(player, message -> {
                        try {
                            ...
                            MenuActions.handleWithdraw(clickedPlayer, island, bankTransaction, null, null, newAmount);
                        } catch (IllegalArgumentException exception) {
                            Message.INVALID_AMOUNT.send(clickedPlayer, message);
                        }
                    ...
                    MenuActions.handleWithdraw(clickedPlayer, island, bankTransaction, null, null, amount);
                }
